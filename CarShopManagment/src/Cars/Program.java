...
public class Program {
	...
	public static void main(String[] args) {
		...
		Client client1 = new Client("Bob","Brown",154,52457,123478,"Bob@gmail.com","Tel Aviv","tutu",14,5468);
        // this is how we can query tables
		client1.InsertClient();
		client1.deleteClient();

		Employee employee1 = new Employee("BOB","BORIWN","manager",45,"18-9-2014","052646","vovy@gmail.com","Holon","JSDF");
		employee1.InsertEmployee();
